...
<footer>
 <img src="{{ public_path('assets/img/footer.png') }}" width="100%" height="100%">  
    ...
    <div class="body_wrapper">
        ...
        <h1 style="color: #0c49a5;text-align: center;">Reporte de Pacientes con mas de 7 controles</h1>
       ...
       <thead>
           <tr>
           <th>Nº</th> 
           <th class="align-middle" style="text-align: center;">Controles</th>
       ...
       <tbody>
           ...
           @if ($paciente->controles->count()>=7)
           <tr>
               <td style="width:25px;text-align: center;">{{$i}}</td> 
                <td class="align-middle" style="text-align: center;">{{ $paciente->controles->count()}}</td>
